if (Meteor.isServer) {
  ...
  setInterval(Meteor.bindEnvironment(function(){
    twitter.get('search/tweets', { q: topic_1 + ' since:2011-11-11 lang:en', count: 15 }, Meteor.bindEnvironment(
  ...
  setTimeout(Meteor.bindEnvironment( function() {
      setInterval(Meteor.bindEnvironment(function(){
      twitter.get('search/tweets', { q: topic_2 + ' since:2011-11-11 lang:en', count: 15 }, Meteor.bindEnvironment(
        function(err, data, response) {
          console.log(data);
